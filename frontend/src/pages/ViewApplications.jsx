...
const ViewApplications = () => {
  return (
    <div className='container  p-3  mx-auto'>
      <div>
        <table className='w-full  max-sm:-mt-[80%] max-w-4xl bg-white border border-gray-200 max-sm:text-sm'>
          <thead>
            ...
            {viewApplicationsPageData.map((applicant,index)=>(
              <tr key={index} className='text-gray-700'>
                ...
                <td className='py-2 px-4 border-b'>
                  <a href='' target='_blank' className='bg-blue-50 text-blue-400 px-3 py-1 rounded inline-flex gap-2 justify-center items-center'>
